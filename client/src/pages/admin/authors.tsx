  ...
  const saveMutation = useMutation({
    mutationFn: async (data: FormValues) => {
      if (selectedAuthor) {
        ...
        const res = await fetch(`/api/autores/${selectedAuthor.id}`, {
          method: "PATCH",
    ...
    onSuccess: () => {
      ...
      toast({
        title: selectedAuthor ? "Autor atualizado" : "Autor criado",
        description: selectedAuthor
          ? "Os dados do autor foram atualizados com sucesso"
          : "O novo autor foi adicionado com sucesso",
      });
      form.reset();
